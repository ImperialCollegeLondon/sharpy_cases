...
# Renewed XHALE with variable wake discretisation by Gregor Wilson, March 2024
# ============================================================================
...
for case in cases:
    vertical_tail = True
    if vertical_tail:
        case_name = 'gust_xhale_vertical_15_0_15_' + case
        print('Generating xhale with vertical Ctail')
    else:
        case_name = 'gust_xhale_vertical_15_0_15_' + '_' + case
    ...
    if vertical_tail:
        ...
        # alpha = 7.6178*np.pi/180          # commented out trim values are for the untwisted wing
...
# FUNCTIONS-------------------------------------------------------------
    ...
    def generate_solver_file():
        ...
        settings['StepUvlm'] = {'print_info': 'off',
                                ...
                                'velocity_field_input': {'u_inf': u_inf,
                                                          ...
                                                          'gust_parameters': {
                                                              ...
                                                              'gust_component': 2},
                                                          'offset': 30*dt/u_inf}, #-space_offset},
                                'rho': rho,
        ...
        # #n_tstep = int(settings['solver_settings']['n_time_steps'])
        # #dt = float(settings['solver_settings']['dt'])
        # elev_file = route + 'elev.csv'
        

        # elev_hist = np.linspace(0, n_tstep*dt, n_tstep)
        # elev_hist = 45.0/180.0*np.pi*elev_hist
        ...
        settings['DynamicCoupled'] = {'structural_solver': 'NonLinearDynamicCoupledStep',
                                    ...
                                    #   'controller_settings':{'controller_elevator': {'P': gains_elev[0],
                                    #                                             'I': gains_elev[1],
                                    #                                             'D': gains_elev[2],
                                    #                                             'dt': dt,
                                    #                                             'input_type': 'm_y',
                                    ...
                                    #                                             'time_history_input_file': 'elev.csv',
                                    #                                             'use_initial_value': True,
                                    #                                             'initial_value': cs_deflection
                                    #                                             }},
